...
__all__ = [
    'SPWF_INPUT', 'DISPID_SVSRunningState', 'DISPID_SPIGetText',
    'SPVPRI_OVER', 'SpeechRegistryLocalMachineRoot', 'SPRST_ACTIVE',
    'DISPID_SABIBufferSize', 'SPWORD', 'DISPID_SpeechVoiceStatus',
    'DISPIDSPTSI_ActiveLength', 'SPPS_Noncontent',
    'DISPID_SOTCDefault', 'DISPID_SVVolume',
    'DISPID_SRGCmdLoadFromObject', 'eLEXTYPE_USER_SHORTCUT',
    'eLEXTYPE_RESERVED8', 'eLEXTYPE_PRIVATE16', 'SPEI_TTS_PRIVATE',
    'SPCATEGORYTYPE', 'ISpeechPhraseAlternates', 'SPEI_SOUND_END',
    'DISPID_SPPValue', 'eLEXTYPE_RESERVED6',
    'DISPID_SPEEngineConfidence', 'SpVoice', 'ISpStream', 'STCAll',
    'ISpeechPhoneConverter', 'eLEXTYPE_RESERVED4',
    'SAFTADPCM_22kHzStereo', 'SPDKL_CurrentConfig',
    'DISPID_SPPFirstElement', 'SVEAudioLevel', 'DISPID_SOTSetId',
    'DISPID_SPEAudioTimeOffset', 'SPEI_RECO_STATE_CHANGE',
    'DISPIDSPTSI_SelectionLength', 'eLEXTYPE_PRIVATE10', 'SLTUser',
    'SVSFParseMask', 'SpeechVoiceCategoryTTSRate',
    'ISpeechMemoryStream', 'SPEI_RESERVED2', 'SGDSInactive',
    'SPSERIALIZEDRESULT', 'SPINTERFERENCE', 'SDTRule', 'SRAExport',
    'DISPID_SVEAudioLevel', 'DISPID_SRCVoicePurgeEvent',
    'SpeechTokenContext', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTsItem', 'DISPID_SpeechRecoResult', 'SPBO_AHEAD',
    'SAFT48kHz8BitStereo', 'DISPID_SASetState',
    'DISPID_SRCAudioInInterferenceStatus', 'IEnumString',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPEPronunciation',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPBOOKMARKOPTIONS',
    'SPEI_PHRASE_START', 'DISPID_SGRsCount', 'SRAImport',
    'SpeechLexiconType', 'SWPKnownWordPronounceable',
    'SpResourceManager', 'SpeechCategoryPhoneConverters',
    'SpPhoneticAlphabetConverter', 'SPGRAMMARWORDTYPE',
    'SPCT_SUB_DICTATION', 'DISPID_SOTCGetDataKey',
    'SpeechAudioFormatGUIDText', 'DISPID_SPRsCount',
    'DISPID_SRGetPropertyNumber', 'SAFTGSM610_22kHzMono',
    'DISPID_SVVoice', 'DISPID_SMSALineId', 'DISPID_SLPPartOfSpeech',
    'SVP_16', 'SPWORDLIST', 'DISPID_SVGetVoices',
    'SPSEMANTICERRORINFO', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SOTGetAttribute', 'SRSActiveAlways',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechLexiconWords',
    'DISPID_SRDisplayUI', 'DISPID_SRCERecognition',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechRecoResultTimes',
    'SREBookmark', 'DISPID_SLWs_NewEnum', 'DISPID_SpeechObjectToken',
    'SRAORetainAudio', 'DISPID_SPEs_NewEnum',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPRECORESULTTIMES',
    'DISPIDSPTSI_ActiveOffset', 'SPRST_INACTIVE',
    'SAFT32kHz16BitMono', 'SVP_5', 'DISPID_SPILanguageId',
    'DISPID_SpeechRecognizer', 'SPINTERFERENCE_LATENCY_WARNING',
    'SECFEmulateResult', 'DISPID_SRCState',
    'DISPID_SRSCurrentStreamPosition', 'SpeechAudioState',
    'SpeechVoiceEvents', 'SDTDisplayText', 'SpeechVoicePriority',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_RESERVED3', 'SPEI_UNDEFINED',
    'DISPID_SDKGetStringValue', 'SPCONTEXTSTATE', 'SVSFParseSapi',
    'SpeechRecoEvents', 'SPPS_SuppressWord', 'SpeechFormatType',
    'DISPID_SPAStartElementInResult', 'DISPID_SOTId', 'SPFILEMODE',
    'eLEXTYPE_PRIVATE15', 'DISPID_SPCIdToPhone', 'ISpVoice',
    'SPXRO_Alternates_SML', 'DISPID_SVAlertBoundary',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPPName',
    'SAFT12kHz16BitStereo', 'tagSTATSTG', 'SAFTADPCM_11kHzMono',
    'SP_VISEME_8', 'DISPID_SRCreateRecoContext', 'SPSHT_EMAIL',
    'SGSExclusive', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT44kHz16BitStereo', 'SPVPRIORITY',
    'DISPID_SpeechVoiceEvent', 'SVP_15', 'SpeechPartOfSpeech',
    'SGSDisabled', 'SPEI_RESERVED6', 'SPPHRASEREPLACEMENT',
    'SpShortcut', 'SPINTERFERENCE_NOISE', 'SPPS_Function',
    'SPINTERFERENCE_TOOLOUD', 'SREPropertyNumChange',
    'SREPropertyStringChange', 'DISPID_SPERequiredConfidence',
    'SpObjectTokenCategory', 'SpCustomStream', 'STSF_AppData',
    'eLEXTYPE_PRIVATE8', 'SpeechCategoryAudioOut',
    'DISPID_SRRAudioFormat', 'ISpeechGrammarRuleStateTransitions',
    'SPAUDIOBUFFERINFO', 'DISPID_SOTIsUISupported',
    'DISPID_SpeechPhraseProperty', 'SAFTADPCM_44kHzStereo',
    'SITooFast', 'ISpeechObjectTokens', 'SRCS_Disabled',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCESoundEnd',
    'DISPID_SOTCEnumerateTokens', 'SLTApp',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPAUDIOSTATE',
    'ISpeechAudioStatus', 'SPFM_OPEN_READWRITE', 'DISPID_SPRuleId',
    'SAFTGSM610_8kHzMono', 'Speech_Default_Weight', 'SPEI_MAX_TTS',
    'DISPID_SRCRecognizer', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechGrammarRule', 'SpInprocRecognizer',
    'SpeechRunState', 'DISPID_SLPLangId', 'DISPID_SpeechAudio',
    'ISpMMSysAudio', 'Speech_StreamPos_RealTime', 'SVPNormal',
    'SREInterference', 'SAFT11kHz8BitMono', 'SAFT48kHz16BitStereo',
    'SPEI_SR_PRIVATE', 'SPSHORTCUTPAIRLIST', 'SPDKL_DefaultLocation',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRCEPropertyNumberChange',
    'SPBINARYGRAMMAR', 'SP_VISEME_4', 'SAFT8kHz8BitStereo',
    'DISPID_SOTGetDescription', 'DISPID_SOTRemove', 'SP_VISEME_21',
    'SpeechLoadOption', 'DISPID_SABufferInfo', 'DISPID_SMSSetData',
    'SP_VISEME_10', 'DISPID_SDKSetLongValue', 'SINoSignal',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SLAddPronunciation',
    'ISpeechRecoGrammar', 'ISpeechPhraseReplacement',
    'IInternetSecurityManager', 'DISPID_SVEWord',
    'SAFT48kHz16BitMono', 'DISPID_SPERetainedStreamOffset',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpeechPhraseInfoBuilder',
    'SpeechAddRemoveWord', 'SDTAudio',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SpeechGrammarRules',
    'DISPID_SPPsCount', 'ISpLexicon', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechXMLRecoResult', 'SPPS_RESERVED3', 'ISpObjectToken',
    'SpeechVoiceSpeakFlags', 'SpPhoneConverter', 'DISPID_SRStatus',
    'DISPID_SOTDataKey', 'SpeechUserTraining', 'SpSharedRecognizer',
    'DISPID_SRGetFormat', 'SAFTADPCM_8kHzStereo', 'SP_VISEME_19',
    'DISPID_SPCPhoneToId', 'SPEI_RECO_OTHER_CONTEXT',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPPChildren', 'SGRSTTEpsilon',
    'ISpeechPhraseElement', 'DISPID_SVDisplayUI', 'SPPHRASERULE',
    'DISPID_SRCResume', 'DISPID_SWFEExtraData',
    'SpeechBookmarkOptions', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SABufferNotifySize', 'SPEI_SOUND_START',
    'SPEI_HYPOTHESIS', 'SVP_2', 'SVP_8', 'WAVEFORMATEX',
    'SGDSActiveWithAutoPause', 'DISPID_SpeechPhraseRule',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPSHORTCUTPAIR',
    'DISPID_SLPs_NewEnum', 'SVPOver', 'ISpRecoGrammar',
    'DISPID_SRRRecoContext', 'SVEWordBoundary', 'SPLO_STATIC',
    'ISpNotifySource', 'SGLexical', 'SSSPTRelativeToCurrentPosition',
    'IEnumSpObjectTokens', 'DISPID_SPEsCount', 'ISpeechWaveFormatEx',
    'DISPID_SOTs_NewEnum', 'SP_VISEME_16',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SGRName',
    'SpeechCategoryAppLexicons', 'ISpeechCustomStream',
    'SPFM_NUM_MODES', 'SPFM_CREATE_ALWAYS', 'DISPID_SLWLangId',
    'DISPID_SRCSetAdaptationData', 'ISpShortcut', 'SPEI_REQUEST_UI',
    'SpeechDiscardType', 'SGPronounciation',
    'ISpeechGrammarRuleState', 'SpeechRuleAttributes',
    'ISpeechTextSelectionInformation', 'SPWORDPRONUNCIATION',
    'ISpeechRecoResult', 'DISPID_SRRTStreamTime', 'SPPS_Interjection',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechRecoContext',
    'ISpResourceManager', 'DISPID_SPEDisplayText', 'SVF_None',
    'SPRECOGNIZERSTATUS', 'SpeechWordPronounceable',
    'DISPID_SRGSetTextSelection', 'ISpRecoContext2',
    'DISPID_SWFEChannels', 'SVP_7', 'SP_VISEME_18',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFT22kHz16BitStereo', 'SREHypothesis',
    'DISPID_SOTRemoveStorageFileName', 'SPSMF_SAPI_PROPERTIES',
    'ISpeechPhraseProperties', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SVSInputWordLength', 'SAFT12kHz8BitMono',
    'SAFT16kHz8BitMono', 'DISPID_SOTMatchesAttributes', 'SVP_1',
    'SVP_6', 'DISPID_SBSSeek', 'SPCS_ENABLED', 'DISPID_SVSkip',
    'SpeechStreamSeekPositionType', 'SpFileStream',
    'DISPID_SRGDictationSetState', 'ISpRecognizer2', 'SVSFPersistXML',
    'SPSLMA', 'SECFIgnoreWidth', 'DISPID_SOTCreateInstance',
    'SPAR_Unknown', 'DISPID_SPEDisplayAttributes', 'DISPID_SASState',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SADefaultFormat', 'SAFTCCITT_ALaw_8kHzMono',
    'SDTLexicalForm', 'DISPID_SGRsItem', 'DISPID_SPISaveToMemory',
    'DISPID_SLGenerationId', 'ISpStreamFormatConverter',
    'eLEXTYPE_PRIVATE3', 'SDTPronunciation', 'DISPID_SVEPhoneme',
    'SPCT_SLEEP', 'ISpNotifySink', 'ISpDataKey', 'SPGRAMMARSTATE',
    'SpeechCategoryAudioIn', 'eLEXTYPE_PRIVATE2',
    'SRSInactiveWithPurge', 'DISPID_SpeechDataKey',
    'DISPID_SDKDeleteValue', 'DISPID_SWFEFormatTag',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVSpeakStream',
    '_SPAUDIOSTATE', 'SPWAVEFORMATTYPE', 'SpStreamFormatConverter',
    'DISPID_SPEsItem', 'ISpRecoContext', 'SpeechCategoryVoices',
    'DISPID_SRGIsPronounceable', 'ISpeechVoiceStatus',
    'SAFT11kHz16BitStereo', 'ISpeechXMLRecoResult',
    'SpeechPropertyResponseSpeed', 'SpeechSpecialTransitionType',
    'SDA_No_Trailing_Space', 'SVF_Stressed',
    'DISPID_SpeechPhraseInfo', 'ISpeechLexiconWords',
    'SPRST_NUM_STATES', 'DISPID_SBSWrite',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRProfile',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRRPhraseInfo',
    'ISpeechAudio', 'SPPS_RESERVED2', 'ISpeechPhraseRules',
    'SRSEDone', 'SVSFIsNotXML', 'SECFNoSpecialChars', 'SVSFlagsAsync',
    'SREAdaptation', 'SGRSTTWord', 'DISPID_SVRate',
    'DISPID_SGRSTsCount', 'SFTInput', 'SPEI_START_SR_STREAM',
    'DISPID_SREmulateRecognition', 'DISPID_SGRsCommitAndSave',
    'SpeechDisplayAttributes', 'ISpeechGrammarRules',
    'DISPID_SGRsDynamic', 'SpObjectToken', 'DISPID_SPIAudioSizeTime',
    'DISPID_SGRsFindRule', 'Speech_Max_Word_Length',
    'SPEI_START_INPUT_STREAM', 'DISPID_SDKOpenKey', 'SREAllEvents',
    'DISPID_SAStatus', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPIProperties', 'DISPID_SMSAMMHandle',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SOTDisplayUI',
    'SAFT16kHz16BitStereo', 'DISPID_SGRSTPropertyName',
    'ISpeechPhraseProperty', 'SRSEIsSpeaking',
    'DISPID_SpeechPhraseBuilder', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechPropertyAdaptationOn', 'SpeechAudioProperties',
    'SPEI_RESERVED5', 'SAFTCCITT_uLaw_8kHzMono', 'SPCT_SUB_COMMAND',
    'SpPhraseInfoBuilder', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_RESERVED7', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCEPhraseStart', 'SREPrivate', 'SSSPTRelativeToStart',
    'SpeechTokenShellFolder', 'SREStreamEnd',
    'SpeechEmulationCompareFlags', 'DISPID_SPRulesItem',
    'DISPID_SRCEStartStream', 'SP_VISEME_15', 'eLEXTYPE_PRIVATE18',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFT16kHz16BitMono',
    'ISpRecognizer', 'SPEI_SR_BOOKMARK', 'DISPID_SVStatus',
    'ISpSerializeState', 'SVEViseme', 'SPAUDIOOPTIONS',
    'DISPID_SPRulesCount', 'DISPID_SVSInputWordPosition',
    'DISPID_SPRuleEngineConfidence', 'SAFT32kHz8BitMono',
    'DISPID_SRGRules', 'SpeechVisemeType', 'SPEI_RESERVED1',
    'DISPID_SAFType', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SDKCreateKey', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRCEBookmark', 'ISpeechGrammarRuleStateTransition',
    'SPEI_MIN_TTS', 'SPSHT_OTHER', 'STCInprocServer',
    'DISPID_SVPause', 'SGDisplay', 'DISPID_SLGetWords',
    '_ISpeechRecoContextEvents', 'DISPID_SRGCmdSetRuleState', 'SVP_9',
    'DISPID_SRAudioInput', 'DISPID_SGRSAddRuleTransition',
    'SPCT_COMMAND', 'DISPID_SRCESoundStart', 'DISPID_SRCPause',
    'SAFT12kHz8BitStereo', 'SRERequestUI', 'SVP_4', 'SRTAutopause',
    'DISPID_SpeechAudioFormat', 'SASStop', 'DISPID_SRCVoice',
    'SPEI_TTS_AUDIO_LEVEL', 'SPRULESTATE', 'SAFT24kHz8BitMono',
    'SAFT24kHz16BitMono', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPEI_INTERFERENCE', 'DISPID_SVResume',
    'DISPID_SRGetPropertyString', 'ISpPhrase',
    'SpeechGrammarWordType', 'SPPHRASE', 'SPINTERFERENCE_NONE',
    'DISPID_SWFEBlockAlign', 'SpeechTokenKeyFiles',
    'ISpeechRecoResultDispatch', 'SSFMCreate', 'SPPROPERTYINFO',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPPParent',
    'SRTEmulated', 'SpeechAudioVolume',
    ...
    'SAFT44kHz8BitStereo', 'SVEPrivate', 'SVSFIsXML',
    'SGRSTTWildcard', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechMMSysAudio', 'eLEXTYPE_RESERVED10',
    'DISPID_SVAudioOutput', 'ISpNotifyTranslator', 'SPAS_RUN',
    'DISPID_SRCRetainedAudio', 'SPSNotOverriden',
    'DISPID_SPIAudioStreamPosition', 'SpeechTokenKeyAttributes',
    'SP_VISEME_17', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRSAudioStatus', 'SAFTADPCM_11kHzStereo',
    'DISPID_SGRSTNextState', 'DISPID_SGRAddState', 'SWTDeleted',
    'SAFT8kHz16BitStereo', 'SRERecoOtherContext',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRRGetXMLResult',
    'SPRS_INACTIVE', 'ISpeechRecoContext',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVEEnginePrivate',
    'SAFT16kHz8BitStereo', 'SVP_10', 'SRADefaultToActive',
    'SECHighConfidence', 'DISPID_SpeechLexiconWord', 'SVP_14',
    'SINone', 'DISPID_SpeechLexiconPronunciation', 'SVF_Emphasis',
    'SpeechInterference', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPIGrammarId', 'DISPID_SGRSTs_NewEnum', 'SPSNoun',
    'ISpeechPhraseRule', 'SpeechVoiceSkipTypeSentence',
    'SpeechAudioFormatType', 'SAFTADPCM_22kHzMono', 'SREStateChange',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRGReset',
    'SPRS_ACTIVE', 'SVSFIsFilename', 'SPEI_SR_RETAINEDAUDIO',
    'SSTTTextBuffer', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechPhraseRules', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCEEndStream', 'SVSFNLPSpeakPunc', 'SPSHT_Unknown',
    'DISPID_SDKGetBinaryValue', 'ISpeechPhraseElements',
    'SVSFUnusedFlags', 'SPPARTOFSPEECH', 'DISPID_SVSpeak',
    'SAFT24kHz8BitStereo', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPPConfidence', 'DISPID_SRCCmdMaxAlternates',
    'DISPIDSPRG', 'DISPID_SVWaitUntilDone', 'SRCS_Enabled',
    'SpeechRecoContextState', 'SPSInterjection', 'SP_VISEME_12',
    'DISPID_SRIsUISupported', 'ISpeechRecognizerStatus',
    'ISpeechPhraseReplacements', 'SPWT_DISPLAY', 'ISpXMLRecoResult',
    'SpMMAudioIn', 'DISPID_SAVolume', 'SpUnCompressedLexicon',
    'SRTExtendableParse', 'DISPID_SVAudioOutputStream', 'ISpAudio',
    'DISPID_SLWsItem', 'SVP_20', 'DISPID_SpeechLexiconProns',
    'DISPID_SVSLastResult', 'SPEVENT', 'DISPID_SRAudioInputStream',
    'DISPID_SPPs_NewEnum', 'SVP_3', 'SFTSREngine', 'SVP_12',
    'SWPUnknownWordUnpronounceable', '__MIDL_IWinTypes_0009',
    'SPDKL_LocalMachine', 'SpeechTokenValueCLSID',
    'DISPID_SMSADeviceId', 'DISPID_SBSFormat',
    'SpeechEngineConfidence', 'DISPID_SRCRequestedUIType',
    'SPAS_STOP', 'DISPID_SRIsShared', 'SRTStandard',
    'SPADAPTATIONRELEVANCE', 'DISPID_SpeechCustomStream', 'SASPause',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechMemoryStream', 'SpMMAudioEnum',
    'DISPID_SVSInputSentenceLength',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechAudioFormatGUIDWave', 'SPEI_VOICE_CHANGE', 'SPRECOSTATE',
    'DISPID_SRCEInterference', 'DISPID_SAFSetWaveFormatEx',
    'SpeechRetainedAudioOptions', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRGetRecognizers', 'eLEXTYPE_PRIVATE6', 'SPGS_ENABLED',
    'DISPID_SGRSAddSpecialTransition', 'SPSTREAMFORMATTYPE',
    'ISpeechPhraseAlternate', 'SVEVoiceChange',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpTextSelectionInformation',
    'DISPID_SPRuleName', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SLGetGenerationChange', 'eLEXTYPE_PRIVATE17',
    'DISPID_SVEStreamStart', 'DISPID_SGRAttributes', 'SRAONone',
    'DISPID_SGRSTWeight', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SDKEnumKeys', 'SPEVENTENUM', 'DISPID_SRGState',
    'DISPID_SpeechAudioStatus', 'DISPID_SVGetAudioInputs',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechPhoneConverter',
    'SPDKL_CurrentUser', 'SPPS_NotOverriden', 'DISPID_SRRAlternates',
    'SPWF_SRENGINE', 'DISPID_SOTCategory',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_USER',
    'SP_VISEME_6', 'SpeechCategoryRecognizers',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPAR_High', 'SPLEXICONTYPE',
    'SpeechWordType', 'DISPID_SPEActualConfidence',
    'DISPID_SPRs_NewEnum', 'DISPID_SPRuleChildren',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRCEEnginePrivate',
    'SSFMOpenForRead', 'DISPID_SRRTOffsetFromStart',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SDKGetlongValue',
    'STSF_FlagCreate', 'SAFT48kHz8BitMono', 'eLEXTYPE_APP',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPFM_OPEN_READONLY',
    'DISPID_SRSetPropertyString', 'SVEStartInputStream',
    'SpInProcRecoContext', 'SpeechTokenKeyUI',
    'SWPUnknownWordPronounceable', 'SDTProperty',
    'SVESentenceBoundary', 'SPPS_LMA', 'SVP_21',
    'DISPID_SpeechPhraseElement', 'SECFIgnoreCase',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRRSpeakAudio',
    'ISpeechPhraseInfo', 'SAFT8kHz8BitMono', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRInitialState', 'DISPID_SLWPronunciations',
    'ISpeechLexicon', 'SRESoundEnd',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechResourceLoader',
    'ISpeechRecoResult2', 'SpLexicon', 'DISPID_SRCBookmark',
    'SpeechAllElements', 'SDA_Two_Trailing_Spaces',
    'SAFT32kHz8BitStereo', 'ISpPhoneConverter', 'SPAR_Low',
    'ISpeechLexiconPronunciations', 'DISPID_SPACommit',
    'DISPID_SpeechPhraseReplacement', 'SDKLCurrentConfig',
    'DISPID_SRRAudio', 'SPXMLRESULTOPTIONS',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRGCommit',
    'DISPID_SRRSaveToMemory', 'DISPID_SPEAudioSizeTime',
    'SP_VISEME_1', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPPEngineConfidence',
    'DISPID_SPRuleConfidence', 'SPCT_DICTATION', 'SRTSMLTimeout',
    'DISPID_SLRemovePronunciation', 'SRESoundStart', 'SSTTWildcard',
    'DISPID_SLPType', 'eWORDTYPE_ADDED', 'DISPID_SPELexicalForm',
    'SVSFPurgeBeforeSpeak', 'DISPID_SPRsItem', 'UINT_PTR',
    'ISpeechFileStream', 'DISPID_SVEventInterests',
    'SpeechStreamFileMode', 'SAFT44kHz16BitMono',
    'SAFTADPCM_8kHzMono', 'SpAudioFormat', 'SGRSTTTextBuffer',
    'DISPID_SRSClsidEngine', 'DISPID_SGRSRule', 'SPSHORTCUTTYPE',
    'SGRSTTDictation', 'SP_VISEME_11', 'SREPhraseStart',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVIsUISupported',
    'SAFT12kHz16BitMono', 'SREStreamStart', 'SP_VISEME_20',
    'SPVPRI_NORMAL', 'DISPID_SABIEventBias', 'ISpeechGrammarRule',
    'ISpProperties', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechLexicon',
    'ISpeechObjectTokenCategory', 'SPRECOCONTEXTSTATUS', 'SASRun',
    'DISPID_SRCCreateGrammar', 'SP_VISEME_14',
    'DISPID_SRCEventInterests', 'SVSFDefault', 'SPSERIALIZEDPHRASE',
    'SGRSTTRule', 'DISPID_SVSLastBookmark', 'tagSPPROPERTYINFO',
    'SRADynamic', 'SRERecognition', 'DISPID_SVSPhonemeId',
    'SSTTDictation', 'SAFT32kHz16BitStereo', 'DISPID_SRGId',
    'DISPID_SRGCmdLoadFromFile', 'SPWT_LEXICAL',
    'DISPID_SpeechFileStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVEEndInputStream', 'SVSFNLPMask',
    'SpMMAudioOut', 'DISPID_SGRSTText', 'SPEVENTSOURCEINFO',
    'DISPID_SpeechVoice', 'DISPID_SRCEFalseRecognition',
    'DISPID_SOTsCount', 'IInternetSecurityMgrSite',
    'DISPID_SRGDictationUnload', 'SP_VISEME_2', 'ISpeechVoice',
    'SPEI_PHONEME', 'SPEI_MIN_SR', 'DISPID_SPIAudioSizeBytes',
    'ISpGrammarBuilder', 'STCLocalServer', 'DISPID_SGRs_NewEnum',
    'SpeechRuleState', 'SVSFVoiceMask', 'SpNullPhoneConverter',
    'DISPID_SpeechObjectTokens',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'Speech_Max_Pron_Length', 'SRSActive', 'DISPID_SPPId',
    'DISPID_SPCLangId', 'DISPID_SLPSymbolic',
    'DISPID_SPIRetainedSizeBytes', 'eLEXTYPE_PRIVATE19',
    'DISPID_SVPriority', 'ISpRecoResult', 'DISPID_SRRTTickCount',
    'SP_VISEME_9', 'DISPID_SRSSupportedLanguages', 'SPSModifier',
    'SDTAlternates', 'DISPID_SRGCmdSetRuleIdState', 'SVP_17',
    'ISpRecoGrammar2', 'SAFT8kHz16BitMono', 'SAFTExtendedAudioFormat',
    'SPWORDTYPE', 'SpeechVisemeFeature', 'SDTAll', 'STCInprocHandler',
    'DISPID_SGRSTransitions', 'DISPIDSPTSI_SelectionOffset',
    'SPWORDPRONUNCIATIONLIST', 'SPAR_Medium', 'ISpeechRecognizer',
    'DISPID_SVEStreamEnd', 'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_7',
    'SPPS_Noun', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SVSVisemeId', 'DISPID_SPAsCount', 'SPAS_PAUSE',
    'SPSEMANTICFORMAT', 'SPBO_PAUSE', 'SPGS_EXCLUSIVE',
    'SPVPRI_ALERT', 'DISPID_SRRDiscardResultInfo', 'ISpEventSink',
    'DISPID_SRCERequestUI', 'ISpeechAudioBufferInfo',
    'SPPHRASEELEMENT', 'DISPID_SBSRead', 'ISpeechMMSysAudio',
    'SPXRO_SML', 'LONG_PTR', 'DISPID_SVGetProfiles',
    'SpeechEngineProperties', 'eLEXTYPE_PRIVATE1', 'ISpStreamFormat',
    'DISPID_SRRecognizer', 'SPFM_CREATE', 'DISPID_SPAs_NewEnum',
    'SECLowConfidence', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SpeechBaseStream', 'DISPID_SDKSetStringValue',
    'ISpObjectTokenCategory', 'DISPID_SPRuleNumberOfElements',
    'SpeechGrammarState', 'SpeechRecognitionType',
    'DISPID_SPAPhraseInfo', 'SPEI_VISEME', 'DISPID_SLWWord',
    'SRARoot', 'SPGS_DISABLED', 'DISPID_SLWsCount',
    'SSFMCreateForWrite', 'SDKLLocalMachine', 'SINoise',
    'SAFT11kHz16BitMono', 'DISPID_SVEViseme',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SpeechAudioBufferInfo', 'SpeechDataKeyLocation',
    'SAFTCCITT_ALaw_11kHzMono', 'SDKLDefaultLocation', 'SWTAdded',
    'DISPID_SpeechPhraseAlternates', 'SAFTGSM610_11kHzMono',
    'DISPID_SLPsItem', 'DISPID_SGRId', 'SAFT22kHz8BitMono',
    'SpWaveFormatEx', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRRTLength', 'DISPID_SAFGuid',
    'DISPID_SRRGetXMLErrorInfo', 'IStream', 'SpeechMicTraining',
    'DISPID_SWFEBitsPerSample', 'SLOStatic', 'STSF_CommonAppData',
    'SVSFParseSsml', 'SPDATAKEYLOCATION', 'ISpeechLexiconWord',
    'SpeechRecognizerState', 'DISPID_SPIStartTime',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SVGetAudioOutputs',
    'SpNotifyTranslator', 'ISpeechBaseStream', 'SPBO_TIME_UNITS',
    'SpeechGrammarTagWildcard', 'DISPID_SLPsCount',
    'SAFTNonStandardFormat', 'SVEBookmark', 'ISpeechObjectToken',
    'SPAUDIOSTATUS', 'DISPID_SMSGetData',
    'ISpPhoneticAlphabetSelection', 'SPSUnknown',
    'SPEI_END_INPUT_STREAM', 'DISPID_SPIElements', 'SPAS_CLOSED',
    'DISPID_SGRSTType', 'DISPID_SDKDeleteKey', 'DISPID_SPRText',
    'SAFTNoAssignedFormat', 'SAFTText', 'DISPID_SOTCId', 'SITooQuiet',
    'DISPID_SGRsCommit', 'DISPID_SPERetainedSizeBytes',
    'SVSFParseAutodetect', 'SPEI_END_SR_STREAM', 'SPEI_WORD_BOUNDARY',
    'ISpeechAudioFormat', 'DISPID_SGRSTPropertyId',
    'DISPID_SASNonBlockingIO', 'SPRULE', 'Speech_StreamPos_Asap',
    'SP_VISEME_3', 'SPEI_FALSE_RECOGNITION', 'DISPID_SFSOpen',
    'eWORDTYPE_DELETED', 'SECFDefault',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRCEAdaptation',
    'DISPID_SRCEAudioLevel', 'DISPID_SCSBaseStream', 'SVEPhoneme',
    'SPAO_NONE', 'DISPID_SLGetPronunciations',
    'SpeechTokenIdUserLexicon', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SGRSTRule', 'DISPID_SRState', 'ISpPhraseAlt',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SAFTCCITT_ALaw_22kHzStereo', 'SRAInterpreter',
    'SPPHRASEPROPERTY', 'DISPID_SPIRule', 'SPPS_Modifier',
    'ISpPhoneticAlphabetConverter', 'DISPID_SOTCSetId',
    'DISPID_SFSClose', 'DISPID_SGRSTsItem', 'DISPID_SDKEnumValues',
    'DISPID_SPRDisplayAttributes', 'SPSFunction',
    'DISPID_SVEVoiceChange', 'DISPID_SLWType',
    'DISPID_SpeechPhraseProperties', 'SP_VISEME_13', 'SDTReplacement',
    'ISequentialStream', 'DISPID_SPPsItem', 'DISPID_SPAsItem',
    'DISPID_SVEBookmark', 'SPVOICESTATUS', 'SPSSuppressWord',
    'DISPID_SPRuleParent', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPARecoResult', 'SAFT24kHz16BitStereo', 'SPPS_RESERVED1',
    'SPVISEMES', 'SITooSlow', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPEI_ADAPTATION', 'DISPID_SAEventHandle', 'SPSVerb',
    'DISPID_SPIEngineId', 'STCRemoteServer', 'SpCompressedLexicon',
    'SREAudioLevel', 'SVP_11', 'SPPS_Verb',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SOTGetStorageFileName',
    'SpeechRecoProfileProperties', 'SpMemoryStream', 'DISPID_SGRsAdd',
    'SPLO_DYNAMIC', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SVSCurrentStreamNumber', 'SVP_13',
    'DISPID_SVSLastBookmarkId', 'DISPID_SLPPhoneIds',
    '_ISpeechVoiceEvents', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'eLEXTYPE_PRIVATE14', 'ISpeechDataKey', 'SDKLCurrentUser',
    'SECFIgnoreKanaType', 'SRSInactive', 'SPTEXTSELECTIONINFO',
    'SpSharedRecoContext', 'DISPID_SRRTimes', 'SBONone',
    'DISPID_SRGDictationLoad', 'SRATopLevel', 'ISpEventSource',
    'SAFT44kHz8BitMono', 'SGDSActiveUserDelimited',
    'SpeechRegistryUserRoot', 'SPPS_Unknown',
    'DISPID_SPIReplacements', 'DISPID_SGRClear',
    'DISPID_SPRules_NewEnum', 'eLEXTYPE_PRIVATE20',
    'ISpObjectWithToken', 'SP_VISEME_5', 'DISPID_SVESentenceBoundary',
    'SAFTADPCM_44kHzMono', 'SDA_One_Trailing_Space',
    'SECNormalConfidence', 'SAFTCCITT_uLaw_22kHzMono',
    'SAFTCCITT_uLaw_44kHzMono', 'SPLOADOPTIONS',
    'DISPID_SPRNumberOfElements', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPIDSPTSI', 'STSF_LocalAppData', 'SPWT_PRONUNCIATION',
    'SVP_18', 'DISPID_SpeechPhraseReplacements', 'SBOPause',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechRecoResult2',
    'SITooLoud', 'DISPID_SGRAddResource', 'SPCS_DISABLED',
    'SPPS_RESERVED4', 'SAFTDefault', 'SDA_Consume_Leading_Spaces',
    'SPWORDPRONOUNCEABLE', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechRecoContextEvents', 'SP_VISEME_0',
    'DISPID_SpeechRecognizerStatus', '_RemotableHandle', 'SVPAlert',
    'SVP_19', 'SGLexicalNoSpecialChars', 'SRTReSent', 'SLODynamic',
    'SAFT22kHz16BitMono', 'SREFalseRecognition',
    'SAFT11kHz8BitStereo', 'SpeechCategoryRecoProfiles',
    'SVEAllEvents', 'DISPID_SABIMinNotification',
    'SSSPTRelativeToEnd', 'ISpRecoCategory', 'DISPID_SRGRecoContext',
    'ISpRecognizer3', 'SpStream', 'SSFMOpenReadWrite',
    'eLEXTYPE_PRIVATE4', 'SAFT22kHz8BitStereo',
    'DISPID_SRGSetWordSequenceData', 'SPSMF_UPS', 'SGDSActive',
    'SPSHT_NotOverriden', 'DISPID_SPRFirstElement', 'SASClosed',
    'DISPID_SASCurrentDevicePosition', 'SPEI_MAX_SR',
    'eLEXTYPE_PRIVATE9', 'SPAO_RETAIN_AUDIO',
    'SpeechGrammarTagDictation', 'SPEI_RECOGNITION',
    'eLEXTYPE_RESERVED9', 'SVP_0',
